...
if (is_admin()) 
 {  
    ...
    {     
	 ...
	 if($current_user -> roles[0] == 'administrator')
	  { 
	     ...
	     add_menu_page("GetAll.pl", "GetAll.pl", 0, "getall", "getall_main", plugins_url('getallpl-connector/icon.png'));    
  ...
  function getall_admin_register_head() {
    ...
    $url = WP_PLUGIN_URL.'/getallpl-connector/style.css';
...
function getall_add_tinymce_plugin( $plugin_array ) {
    ...
    $plugin_array['getall_popup'] = plugins_url( '/getallpl-connector/js/plugin.js.php?key='.get_option('getall_key')  );
