	...
	window.addEventListener("message", receiveMessage, false);
	 ...
	 jQuery(document).ready(function(){  
		...
		jQuery("#activate").click(function(){
			...
			window.open('https://www.getall.pl/login.php?action=login&goto=https://www.getall.pl/api/wordpress/connect.php?url=<? echo get_site_url(); ?>', '_blank', 'location=yes,height=600,width=500,scrollbars=yes,status=no');
